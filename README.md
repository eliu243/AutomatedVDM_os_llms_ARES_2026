...
**Dataset C** is a curated positive-only dataset containing high-confidence
...
**Dataset D** extends Dataset C with 4,500 hard negative pairs constructed
...
Each row represents a single CVE--technique pair labeled as positive or negative.